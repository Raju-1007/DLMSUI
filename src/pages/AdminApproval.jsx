...
export default function AdminApproval() {
  ...
  const approveUser = async (id) => {
    await axios.put(import.meta.env.VITE_API_BASE_URL+`/login/login/approve/${id}`);
    loadPendingUsers();
  };

  const rejectUser = async (id) => {
    await axios.put(import.meta.env.VITE_API_BASE_URL+`/login/login/reject/${id}`);
    loadPendingUsers();
  };

  const deleteUser = async (id) => {
    await axios.delete(import.meta.env.VITE_API_BASE_URL+`/login/login/delete/${id}`);
    loadPendingUsers();
  };
